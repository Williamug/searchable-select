# This is my package searchable-select
...
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/williamug/searchable-select/run-tests.yml?branch=main&label=tests&style=flat-square)](https://github.com/williamug/searchable-select/actions?query=workflow%3Arun-tests+branch%3Amain)
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/searchable-select.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/searchable-select)
...
```bash
php artisan vendor:publish --tag="searchable-select-migrations"
php artisan migrate
```
...
```php
$searchableSelect = new Williamug\SearchableSelect();
echo $searchableSelect->echoPhrase('Hello, Williamug!');
```
